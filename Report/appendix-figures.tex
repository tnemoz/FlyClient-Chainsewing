\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Probability of success for \(\gls{mu}=50\%\)}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Probability of success for \(\gls{mu}=25\%\)}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Probability of success for \(\gls{mu}=10\%\)}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Probability of success for \(\gls{mu}=1\%\)}
    \end{subfigure}
    \caption{Probability of success of the \cs\ attack as a function of \gls{Fbar} and \(\gls{n}-\gls{m}\) for different computational powers \gls{mu}}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Number of blocks to wait as a function of the desired probability of success for different computational powers for the first setup for \(\gls{delta}=2^{-10}\)}
