...
\begin{document}
  ...
  \chapter{Background}
    \input{Background}
  \chapter{\textit{Chain-sewing} attacks on \FC}
    \input{Chainsewing.tex}
  \chapter[Probability of success]{Probability of success of the \textit{chain-sewing} attack on \FC}
    \label{chapter:probability}
    \input{Probability}
  \chapter{Mitigating the \textit{chain-sewing} attack on \FC}
    \input{Mitigating}
  \printbibliography
\end{document}
